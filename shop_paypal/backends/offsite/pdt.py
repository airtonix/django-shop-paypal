...
class OffsiteIPNPaypalBackend(object):
    ...
    def __init__(self, shop):
        ...
        payment_was_flagged.connect(self.payment_was_flagged, weak=False)
    ...
    def subscription_cancel(self, sender, **kwargs):
        ''''''
    ...
    def subscription_eot(self, sender, **kwargs):
        ''''''
    ...
    def subscription_modify(self, sender, **kwargs):
        ''''''
    ...
    def subscription_signup(self, sender, **kwargs):
        ''''''
